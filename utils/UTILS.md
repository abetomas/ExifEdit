...
* To maintain interoperability across DAMs, keyword tags are copied and synchronized across the various tags used.  In my workflow, -TagsList is considered the master keyword dictionary, it's contents are periodically copied to -Subject and -HierarchicalSubject.
...
| exifedit.py | GUI front-end for exiftool.  See project homepage |
